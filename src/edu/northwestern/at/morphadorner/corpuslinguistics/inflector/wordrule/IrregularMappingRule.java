...
/**
 * A rule for specifying an irregular inflection using a combination of a map of singular to plural
 * forms and a regular expression replacement.
 *
 * <p>Subclasses can implement {@link #replace} to perform the actual replacement, which by default
 * uses the map to substitute a plural form for the corresponding singular form found in group 0 of
...
public class IrregularMappingRule extends AbstractRegexReplacementRule {
   ...
   * @param regex The regular expression used to match words. Match information is available to
   *     subclasses in the {@link #replace} method.
   */
   ...
   *
   * @param wordMappings Two-dimensional array of strings. First entry is singular form, second
   *     entry is plural form.
