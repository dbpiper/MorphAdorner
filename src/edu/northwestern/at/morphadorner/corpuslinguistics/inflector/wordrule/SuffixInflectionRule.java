 ...
 *
 * <p>For example, the English nouns which have the suffix -y, generally change the suffix to -ies
 * in the plural. Such a rule would be expressed as <code>new SuffixInflectionRule("-y", "-ies")
 * </code>.
 *
...
public class SuffixInflectionRule implements WordRule {
  ...
  /**
   * Construct a rule for a suffix <code>singularSuffix</code> which becomes <code>pluralSuffix
   * </code> in the plural.
   *
   ...
   * @param singularSuffix The singular suffix, starting with a "-" character. The <code>suffix
   *     </code> must end with <code>singularSuffix</code>.
   * @param pluralSuffix The plural suffix, starting with a "-" character.
   */
