...
/**
 * This code is based on an implementation by Ed Parrish, which was obtained from:
 *
 * <p>http://www.cse.ucsc.edu/~eparrish/toolbox/search.html
 *
 * <p>Licensed under an Apache license in the org.apache.commons.codec.language package.
 */
public class DoubleMetaphone {
  ...
  private static final String[] EbEiElEpErEsEyIbIlInIe = {
      ...
      switch (input.charAt(current)) {
        ...
        case 'C':
          ...
          if ((current > 1)
              ...
              && (input.charAt(current + 2) != 'I' && input.charAt(current + 2) != 'E'
        ...
        case 'P':
          ...
          if (charAt(current + 1, BP)) current += 2;
          else current++;
          add('P');
          break;
        ...
        case 'T':
          ...
          if (charAt(current + 1, DT)) current += 2;
          else current++;
          add('T');
          break;
