...
public class ContextVector implements Externalizable {
   ...
   */
  public static double cos(final ContextVector a, final ContextVector b) {
    ...
    for (Iterator<String> iterator = va.table.keySet().iterator(); iterator.hasNext(); ) {
      key = iterator.next();
    ...
    for (Iterator<Frequency> iterator = vb.table.values().iterator(); iterator.hasNext(); ) {
      fB = iterator.next();
   ...
   * @return cosine value.
   */
  public static double cos(final ContextVector a, final ContextVector b, final EntropyVector tf) {
    //  Use smaller vector as primary vector.
    ...
    for (Iterator<String> iterator = vb.table.keySet().iterator(); iterator.hasNext(); ) {
      key = iterator.next();
      fB = vb.table.get(key);
   ...
   */
  public static int inc(final String key, final int increment, ContextVector vector) {
    Frequency f = vector.table.get(key);
  ...
  public final void readExternal(java.io.ObjectInput in)
    ...
    HashMap<String, Frequency> tableObj = (java.util.HashMap<String, Frequency>) in.readObject();
