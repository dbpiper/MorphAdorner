 ...
 *     <p>Modifications by Philip R. Burns at Northwestern University.
 *     <ol>
 *       <li>Allow output column selection and ordering.
 *       <li>Allow specification of file character encoding.
 *       <li>
 *       <li>Use List instead of Vector.
 *     </ol>
 */
public class CSVFileWriter extends CSVFile {
   ...
   * @param encoding Character encoding for file output.
   * @param separator Field separator character. 8
   * @throws FileNotFoundException If file is not found.
   * @throws IOException If an error occurs while writing the file.
   */
   ...
   * @throws IOException If an error occurs while writing the file.
   */
  public CSVFileWriter(String outputFileName, String encoding, char separator, char qualifier)
   ...
   * @throws IOException If an error occurs while writing the file.
   */
  protected void openOutputFile(String outputFileName, String encoding)
      throws FileNotFoundException, IOException {
    ...
    if ((encoding != null) && (encoding.length() > 0)) {
      outputWriter = new OutputStreamWriter(bufferedStream, encoding);
    } else {
  ...
  public void writeValue(String fieldValue) throws IOException {
    boolean addQualifier = (qualifier != 0) && (fieldValue.indexOf(separator) >= 0);
   ...
   *     <p>The integer "indices" specify which entries to write out, and the order. For example, if
   *     "indices" contains the values 3, 4, 1 then entries 3, 4, and 1 from "fields" are written
   *     out in that order. Bad indices result in an empty field being output.
   */
