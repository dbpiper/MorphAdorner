...
/**
 * Extension fo the RandomAccessFile to use buffered I/O as much as possible. Usable with the <code>
 * com.objectwave.persist.FileBroker</code> . Publically identical to <code>java.io.RandomAccessFile
 * </code> , except for the constuctor and <code>flush()</code> .
 *
 ...
 *     <p>Modifications by Philip R. Burns. 2007/05/08.
 */
public class BufferedRandomAccessFile implements DataInput, DataOutput {
  ...
  /**
   * Save any changes and re-read the currBuf.bytes from the given position. Note that the
   * read(byte[],int,int) method assumes that this method sets currBuf.pos to 0.
   *
