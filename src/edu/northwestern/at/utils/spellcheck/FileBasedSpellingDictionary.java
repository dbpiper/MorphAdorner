...
public class FileBasedSpellingDictionary extends HashMapSpellingDictionary {
   ...
   * @throws IOException
   */
  public FileBasedSpellingDictionary(String dictionaryFileName) throws IOException {
    super();
    this.dictionaryFileName = dictionaryFileName;
    try {
      read(new BufferedReader(new FileReader(dictionaryFileName)));
  ...
  private void outputDictionary() throws IOException {
    write(new BufferedWriter(new FileWriter(dictionaryFileName)));
  }
