 ...
 *
 * <p>This interface defines methods for a spelling checker dicionary. The interface provides for
 * looking up words in the dictionary and for adding a word to the dictionary.
 */
public interface SpellingDictionary {
   ...
   * Get related words.
   *
   * @param key The key for the list of related words. Typically this is a hash code like a Soundex
   *     or Metaphone value.
