...
public class Disjunct {
  ...
  static Disjunct eliminate_duplicate_disjuncts(ParseOptions opts, Disjunct d) {
    ...
    */
    ...
    if (opts.verbosity > 2 && count != 0) opts.out.println("killed " + count + " duplicates");
    return d;
  }
  ...
  boolean disjuncts_equal(Disjunct d2) {
    ...
    while (e1 != null && e2 != null) {
      if (!e1.connectors_equal_prune(e2)) break;
      e1 = e1.next;
      e2 = e2.next;
    }
  ...
  */
  ...
  boolean disjunct_types_equal(Disjunct d2) {
    ...
    */
    ...
    e2 = d2.left;
    while ((e1 != null) && (e2 != null)) {
      if (!e1.connector_types_equal(e2)) break;
      e1 = e1.next;
      e2 = e2.next;
    }
    if ((e1 != null) || (e2 != null)) return false;
  ...
  boolean disjuncts_equal_AND(Disjunct d2) {
    ...
    */
    ...
    e2 = d2.left;
    while (e1 != null && e2 != null) {
      if (!e1.connectors_equal_AND(e2)) break;
      e1 = e1.next;
      e2 = e2.next;
    }
    if ((e1 != null) || (e2 != null)) return false;
