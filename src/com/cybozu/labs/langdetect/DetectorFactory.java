 ...
 *
 * <p>This class manages an initialization and constructions of {@link Detector}.
 *
 * <p>Before using language detection library, load profiles with {@link
 * DetectorFactory#loadProfiles(List profiles)} method and set initialization parameters.
 *
 * <p>When the language detection, construct Detector instance via {@link DetectorFactory#create()}.
...
public class DetectorFactory {
   ...
   *     <p>The list of loaded language profiles is set to those specified in the profile names
   *     list.
   */
  public static void loadProfilesByName(List<String> profileNames) {
    ...
    for (int i = 0; i < profileNames.size(); i++) {
      CLangProfile cProfile = getLanguageProfile(profileNames.get(i));
   ...
   * @return Language profile class. Null if not found or could not be instantiated.
   */
