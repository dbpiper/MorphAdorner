 ...
 *
 * <p>This filter pretty-prints field-oriented XML without mixed content. all added indentation and
 ...
 * XML writing tool like the {@link com.megginson.sax.XMLWriter XMLWriter} class cannot add newlines
 * or indentation.
 *
 ...
 * document-oriented XML like XHTML pages, which mix character data and elements together.
 *
 * <p>This writer will automatically place each start tag on a new line, optionally indented if an
 * indent step is provided (by default, there is no indentation). If an element contains other
 ...
 * </pre>
 *
 * <p>This class inherits from {@link com.megginson.sax.XMLWriter XMLWriter}, and provides all of
 * the same support for Namespaces.
 *
 * @author David Megginson, david@megginson.com
 * @version 0.2
 * @see com.megginson.sax.XMLWriter
 *     <p>Use system platform end-of-line sequence instead of just \n. Use typed collections. Philip
 *     R. Burns. 2007/04/23 .
 */
public class DataWriter extends XMLWriter {
   ...
   * Create a new data writer for standard output.
   *
   * <p>Use the XMLReader provided as the source of events.
   *
   ...
   *
   * <p>This method is especially useful if the writer failed with an exception the last time
   * through.
   *
   ...
   * Write a start tag.
   *
   * <p>Each tag will begin on a new line, and will be indented by the current indent step times the
   * number of ancestors that the element has.
   *
   ...
   * @exception org.xml.sax.SAXException If there is an error writing the start tag, or if a filter
   ...
   *
   * <p>Each tag will appear on a new line, and will be indented by the current indent step times
   ...
   * @param qName The element's qualified (prefixed) name.
   * @param atts The element's attribute list.
   * @exception org.xml.sax.SAXException If there is an error writing the empty tag, or if a filter
   *     further down the chain raises an exception.
